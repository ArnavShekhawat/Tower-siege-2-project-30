...
box1 = new Block(300, 380,30,40,"blue");
box2 = new Block(330, 380, 30, 40, "blue");
box3 = new Block(360, 380, 30, 40, "blue");
box4 = new Block(390, 380, 30, 40, "blue");
//upper roof middle 
box5 = new Block(330, 340, 30, 40, "yellow");
box6 = new Block(360, 340, 30, 40, "yellow");
box7 = new Block(390, 340, 30, 40, "yellow");
//upper roof upper one
box8 = new Block(360, 300, 30, 40, "pink");
box9 = new Block(390, 300, 30, 40, "pink");
//upper roof top most
box10 = new Block(390, 260, 30, 40, "green");
